...
#- Define a method beginning with 'test', encompassing main functionality, doing so will allow py.test to automatically detect and run a unit test against it
def test_code(): 
